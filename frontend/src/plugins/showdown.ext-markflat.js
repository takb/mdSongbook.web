...
export default () => {
var sd = new showdown.Converter({extensions: ['sbmd']});
sd.setOption('zoom', 120);
sd.setOption('transposeby', 0);
sd.setOption('addMinorChordMarker', false);
sd.transpose = function(key) {
